---
title: 隐私政策
date: 2024-01-30 13:27:10
comments: false
aside: false
---

### 协议最新更新时间为：2024-01-30

本站非常重视用户的隐私和个人信息保护。你在使用网站时，可能会收集和使用你的相关信息。通过《隐私政策》向你说明在你访问 `blog.kclub.tech` 网站时，如何收集、使用、保存、共享和转让这些信息。
...
- **Cloudflare** 会收集你的访问信息、访问操作过程，用于网站维护
- **GoogleAnalytics** 会收集你的访问信息、访问操作过程，用于网站维护
- **IP Info** 会收集你的访问信息，用于网站维护
- **51la统计工具** 会收集你的访问信息，用于网站维护
- **腾讯云** 会收集你的访问信息，用于提供网站服务
- **网易云音乐** 会收集你的访问信息，用于音乐的展示与播放
...
关于如何使用你的Cookies，请访问[Cookies政策](https://blog.kclub.tech/cookies)。
